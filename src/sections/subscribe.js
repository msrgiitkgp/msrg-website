...
const Subscribe = () => {
  return (
    <Box as="section" sx={styles.subscribe}>
      <Container>
        <Heading as="h3">This website was made by React.js</Heading>
        <Text as="p">
          Static optimization was achieved using Next.js
        </Text>
        <Text as="p">
        ...
        <Box as="form" sx={styles.form}>
          ...
          <Input
            placeholder="This form input does not work as of yet :|"
            type="email"
            id="subscribeEmail"
            sx={styles.input}
          />
